...
main = do
    ...
    if opçao == "1" then do
      ...
      polinómio2 <- getLine
      putStrLn (MyPol.addPolynomialString polinómio1 polinómio2)
...
testing =  do
                  ...
                  putStr  ("x^2 + 2x + 1  +  5x^2 + 3x + 2  =  " ++ MyPol.addPolynomialString "x^2 + 2x + 1" "5x^2 + 3x + 2 ")
                  putStr  "\n"
                  if("6x^2 + 5x + 3" == MyPol.addPolynomialString "x^2 + 2x + 1" "5x^2 + 3x + 2 ") then putStr "Test passed\n" else putStr "Test failed\n"
                  ...
                  putStr  ("x^2y + 2yx + 3yx^2 + 1 + 6x^2y + 3xy + 2x = " ++ MyPol.addPolynomialString "x^2y + 2yx + 3yx^2 + 1" "6x^2y + 3xy + 2x")
                  putStr "\n"
                  if("10x^2y + 5xy + 2x + 1" == MyPol.addPolynomialString "x^2y + 2yx + 3yx^2 + 1" "6x^2y + 3xy + 2x") then putStr "Test passed\n" else putStr "Test failed\n"
                  ...
                  putStr  ("x^2 + 2x + 1  *  2x + 2  =  " ++ MyPol.multiplyPolynomial "x^2 + 2x + 1" "2x + 2")
                  putStr  "\n"
                  if("2x^3 + 6x^2 + 6x + 2" == MyPol.multiplyPolynomial "x^2 + 2x + 1" "2x + 2") then putStr "Test passed\n" else putStr "Test failed\n"
                  ...
                  putStr  ("2x^2y + 3yx^2 + 3yx + 2xy * 2x  =  " ++ MyPol.multiplyPolynomial "2x^2y + 3yx^2 + 3yx + 2xy" "2x")
                  putStr  "\n"
                  if("10x^3y + 10x^2y" == MyPol.multiplyPolynomial "2x^2y + 3yx^2 + 3yx + 2xy" "2x") then putStr "Test passed\n" else putStr "Test failed\n"
